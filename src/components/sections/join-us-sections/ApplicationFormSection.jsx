...
const ApplicationFormSection = () => {
  ...
  if (submitted) {
    return (
      <section className="section-dark-secondary surface-pattern">
    ...
    <section id="application" className="section-dark-secondary surface-pattern">
      <div className="section-container">
        ...
        <form
          ...
          className="mx-auto max-w-4xl bg-[#0F1C3A]/80 border border-white/10 rounded-3xl px-5 py-6 sm:px-8 sm:py-8 shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl"
        >
          {/* STEP 0 – Intro */}
          {step === 0 && (
          ...
          {step === 2 && (
            <div className="space-y-6">
              ...
              <p className="text-sm text-white/75">
                We don&apos;t expect everyone to have robotics experience. We just
              ...
              <div className="space-y-4">
                    ...
                    <div className="flex gap-3 mt-2">
                      {["yes", "no"].map((val) => (
                        <button
                          ...
                          type="button"
                          onClick={() =>
                            handleChange("hasClubExperience", val)
                          }
                          className={`px-3 py-1.5 rounded-full text-xs font-medium border transition-colors ${
                ...
                <div>
                  ...
                  <select
                    className="input bg-[#0D1730] mt-2"
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Tell us why you chose your top roles/projects, relevant skills or experiences, and what you hope to learn and achieve with RoboTUM."
              ...
              <div className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      type="file"
                      accept=".pdf,.doc,.docx"
                      className="block w-full text-sm text-white/80 file:mr-3 file:rounded-full file:border-0 file:bg-accent file:px-4 file:py-1.5 file:text-xs file:font-medium file:text-white hover:file:bg-accent/90"
                  ...
                  <div>
                    ...
                    <input
                      type="file"
                      accept=".pdf,.doc,.docx"
                      className="block w-full text-sm text-white/80 file:mr-3 file:rounded-full file:border-0 file:bg-white/10 file:px-4 file:py-1.5 file:text-xs file:font-medium file:text-white hover:file:bg-white/20"
                      onChange={(e) =>
                ...
                <div className="space-y-2 text-xs text-white/75">
                  <label className="flex items-start gap-2 cursor-pointer">
                    ...
                    />
                    <span>
                      I confirm that the information I provided is accurate to the
          ...
          {step === 6 && (
            <div className="space-y-6">
              ...
              <p className="text-sm text-white/75">
                Please quickly review your answers. If everything looks good, send
                your application.
              </p>

              <div className="space-y-4 text-sm text-white/85">
                <div className="rounded-2xl border border-white/12 bg-[#0D1834]/90 p-4">
                ...
                <div className="rounded-2xl border border-white/12 bg-[#0D1834]/90 p-4">
                  ...
                  {formData.topProjects.length > 0 && (
                    <p className="mt-1">
                      Projects: {formData.topProjects.join(", ")}
                    </p>
                  )}
                </div>

                <div className="rounded-2xl border border-white/12 bg-[#0D1834]/90 p-4 space-y-2">
                  <h4 className="font-semibold mb-2">Motivation & links</h4>
                ...
                <div className="rounded-2xl border border-white/12 bg-[#0D1834]/90 p-4 text-xs text-white/80 space-y-1">
                  <h4 className="font-semibold mb-1">Files & consent</h4>
                  <p>
                    CV:{" "}
                    {formData.cvFile
                  ...
                  <p className="mt-1">
                    Info accurate:{" "}
                    {formData.confirmInfoAccurate ? "Yes" : "No"}
                  </p>
                  <p>
