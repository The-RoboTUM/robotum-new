...
export const projects = [
  ...
  },
  {
    ...
    description: 'From our Partnership with TU Design last Semester, we have an amazing website design waiting to be implemented. Help to shape RoboTUM\'s online presence and work on your web development skills!',
  ...
  },
  {
    ...
    description: 'Together with our sponsor, Reply, we\'re developing a cutting-edge software stack that expands on the autonomous capabilities of the PUMA Quadruped robot. This project is right for you if your focus is on software in autonomous systems!',
  ...
  // OPERATIONS
  {
    ...
    description: 'RoboTUM is an organization with more than 100 Members that needs a backbone to run on! If you want to help keep RoboTUM running, manage our Members, our Legal and Contractual obligations, or get some practical experience in Financial Accounting, RoboTUM needs you!',
  ...
  },
  {
    ...
    description: 'Help bring together the RoboTUM Community by planning cool events, Bar evenings, multi-day retreats, or anything else that could be fun!',
  ...
  },
  {
    ...
    description: 'Want to engage with other RoboTUM members and discuss an interesting book or go on a DnD Campaign? Help organize it here!',
  ...
  },
  {
    ...
    description: 'Creating Value for our Members by hosting and organizing Weekly Workshops to bring together the community and share knowledge. If you want to help create interesting events and share knowledge across our members, this is the right place for you!',
  ...
  },
  {
    ...
    description: 'In addition to bringing together Robotics Talent in Gen R, we also want to deliver a platform for entrepreneurially minded roboticists, set up workshops, engage with VC Funds, Industry Partners, Accelerators like EF, and other stakeholders, to build amazing deep tech/Robotics companies!',
  ...
  },
  {
    ...
    description: 'Planned for April next year, RoboTUM wants to bring together the whole Robotics Ecosystem from all over Germany and Europe and host a full week of amazing Robotics Events all over Munich!',
  ...
  },
  {
    ...
    description: 'Our Podcast continues as it exists right now, but needs passionate talent to lift it to the next level, increase its reach, and find amazing Partners! Join now to spread the Robotics Gospel.',
  ...
  },
  {
    ...
    description: 'Unite with Bavaria\'s leading robotics and AI innovators at Google HQ Munich for a day of groundbreaking insights and game-changing connections.',
