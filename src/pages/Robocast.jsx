  ...
  return (
    ...
    >
      {ep.cover_url ? (
        ...
        <div className="h-28 sm:h-32 bg-[radial-gradient(circle_at_30%_20%,rgba(59,130,246,0.25),transparent_55%)] border-b border-white/10" />
      )}
      ...
      <section className="section-container hero-offset font-sans text-white section-dark-primary surface-pattern">
        ...
        <div className="grid gap-8 md:gap-10 lg:grid-cols-12 items-center">
          <div className="lg:col-span-6 space-y-3 sm:space-y-4">
            ...
            <div className="mt-3 sm:mt-4 rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-5 backdrop-blur-sm max-w-2xl">
              ...
              <p className="text-sm md:text-base text-white/75 leading-relaxed">
                ...
                It’s a platform where real stories meet the newest technology trends.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 sm:gap-4 mb-5 sm:mb-6">
            ...
            {featured?.spotify_url ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-white/15 bg-white/5 px-5 py-2 text-sm text-white/85 hover:bg-white/10 hover:border-white/30 transition w-full sm:w-auto"
              >
                <img
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="sm:hidden -mx-6 px-6">
                <div className="flex gap-4 overflow-x-auto snap-x snap-mandatory no-scrollbar pb-2" role="list">
                  {episodes.map((ep) => (
                    <div
                      key={ep.id}
                      className="snap-start min-w-[88%] max-w-[88%]"
                    >
                      <EpisodeCard ep={ep} />
                    </div>
                  ))}
              ...
              {/* DESKTOP/TABLET: grid */}
              <div className="hidden sm:grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5" role="list">
                {episodes.map((ep) => (
